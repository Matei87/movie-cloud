  ...
  const handleAll = useCallback(async () => {
    try {
      ...
      setData({
        ...
        tvTrendingWeek: data[1].results,
        tvTrendingDay: data[2].results,
      });
    } catch (error) {
      console.log(error);
    }
  }, [MOVIE_TRENDINGWEEK, TV_TRENDINGDAY, TV_TRENDINGWEEK]);
            ...
            <div className='discover-trends-movies-container-content'>
              <Slider {...sets}>
                {movieTrendingWeek.map((content) => (
                  <div
                    className='discover-trends-movies-container-item'
                    key={content.id}
                  >
                    <img
            ...
            <div className='discover-trends-tv-container-content'>
              <Slider {...sets}>
                {tvTrendingWeek.map((content) => (
                  <div
                    className='discover-trends-tv-container-item'
                    key={content.id}
                  >
                    <img
                      src={`https://image.tmdb.org/t/p/w1280${
          ...
          <div className='discover-tvtrending-container-content'>
            <Slider {...sets}>
              {tvTrendingDay.map((content) => (
                <div
                  className='discover-tvtrending-container-item'
                  key={content.id}
                >
                  <img
                    src={`https://image.tmdb.org/t/p/w1280${
                  ...
                  <div className='discover-tvtrending-container-item-content'>
                    <div className='discover-tvtrending-container-item-content-item'>
                      ...
                      >
                        <img
                          src={`https://image.tmdb.org/t/p/w1280${content.poster_path}`}
                          alt={content.name}
                        />
                      </Link>
                    ...
                    <div className='discover-tvtrending-container-item-content-item-description'>
                      ...
                      <span>
                        {content.overview.split(' ').length > 30
                          ? content.overview.split(' ').slice(0, 20).join(' ') +
                            '.'
                          : content.overview}
                      </span>
                    </div>
